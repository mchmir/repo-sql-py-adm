...
--логируем
insert into dbo.ClosePeriodLog (SPName,StepName,DateExec)
values ('ActionForPeriod','Пересчет балансов пред.периода',GetDate())
...
--логируем
insert into dbo.ClosePeriodLog (SPName,StepName,DateExec)
values ('ActionForPeriod','Пересчет балансов нового периода',GetDate())
...
--логируем
insert into dbo.ClosePeriodLog (SPName,StepName,DateExec)
values ('ActionForPeriod','Закончили',GetDate())
