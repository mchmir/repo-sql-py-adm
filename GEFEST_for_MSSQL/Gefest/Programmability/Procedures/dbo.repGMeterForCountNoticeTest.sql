...
CREATE procedure [dbo].[repGMeterForCountNoticeTest] (@IdGRU int, @IdPeriod int, @IDContract int) as 
...
select ac.idaccounting, ac.name, @IDContract idcontract,
...
union all
select name,0,0,0,0,0,balancebegin,summoplat,summanach,balanceend,0,'',0,'','','','',0,0
from #tmpAcc
