...
GO
CREATE PROCEDURE [dbo].[spRecalcBalances](@idContract as int, @idPeriod as int) AS
...
where b2.idBalance is null and b1.AmountBalance<>0 and b1.idPeriod=@idPrevPeriod
