...
CREATE procedure [dbo].[repCountNotice] (@IdGRU int, @IdPeriod int) as 
---------------*************Счет-извещение**********------------------
--exec repCountNoticeOld @IdGRU, @IdPeriod
if @IdPeriod=122
begin
	exec repCountNoticeGMNewTariff @IdGRU, @IdPeriod
end
else
begin
	exec repCountNoticeGM @IdGRU, @IdPeriod
end
--exec repCountNoticeGMNewTariff @IdGRU, @IdPeriod
