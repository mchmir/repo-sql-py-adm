...
values ('CloseNowPeriod','Начали',GetDate())
--
--распределим без ПУ
...
--логируем
insert into dbo.ClosePeriodLog (SPName,StepName,DateExec)
values ('CloseNowPeriod','Распределили без ПУ',GetDate())
--
...
--логируем
insert into dbo.ClosePeriodLog (SPName,StepName,DateExec)
values ('CloseNowPeriod','Начислили по среднему - есть ПУ нет показаний',GetDate())
--
