...
CREATE PROCEDURE [dbo].[repRevizia]  AS

select  dbo.fGetLastRevizDateVerify(a.idhouse)fir, s.name+ ', '+ltrim(str(hs.housenumber))+isnull(hs.housenumberchar,'') Adres,count (c.idcontract)cou
