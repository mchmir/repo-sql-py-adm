...
namespace Gefest
{
	public class frmPrintReestrOplOfBank : Form
	{
		...
		public frmPrintReestrOplOfBank()
		{
		...
		private void frmReestrOplOfBank_Load(object sender, EventArgs e)
		{
		...
		{
			ResourceManager resourceManager = new ResourceManager(typeof(frmPrintReestrOplOfBank));
			...
			this.cmdClose.Location = new Point(212, 72);
			...
			this.cmdOK.Location = new Point(108, 72);
			this.cmdOK.Name = "cmdOK";
			this.cmdOK.Size = new System.Drawing.Size(96, 24);
			this.cmdOK.TabIndex = 69;
			...
			this.label2.Location = new Point(152, 8);
			...
			this.dtBegin.Location = new Point(24, 8);
			this.dtBegin.Name = "dtBegin";
			this.dtBegin.Size = new System.Drawing.Size(120, 18);
			this.dtBegin.TabIndex = 69;
			...
			this.dtEnd.Location = new Point(176, 8);
			...
			base.ClientSize = new System.Drawing.Size(306, 98);
			base.Controls.Add(this.cmdClose);
			base.Controls.Add(this.cmdOK);
			base.Controls.Add(this.groupBox1);
			base.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
			base.Name = "frmPrintReestrOplOfBank";
			this.Text = "Реестр оплыты в Банк";
			base.Load += new EventHandler(this.frmReestrOplOfBank_Load);
		...
		private void Rep(long Agent)
		{
			try
			{
				try
				{
					...
					string str1 = string.Concat(Depot.oSettings.ReportPath.Trim(), "repReestrOplOfBank.rpt");
