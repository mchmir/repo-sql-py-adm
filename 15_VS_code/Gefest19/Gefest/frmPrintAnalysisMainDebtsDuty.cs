...
namespace Gefest
{
	public class frmPrintAnalysisMainDebtsDuty : Form
	{
		...
		public frmPrintAnalysisMainDebtsDuty()
		{
		...
		private void cmdOK_Click(object sender, EventArgs e)
		{
			try
			{
				try
				{
					...
					string str1 = string.Concat(Depot.oSettings.ReportPath.Trim(), "repAnalysisMainDebtsDuty.rpt");
					Form frmReport = new frmReports(str1, strArrays, strArrays1, numArray)
					{
						Text = "Анализ дебиторской задолженности по основному долгу",
		...
		private void frmPrintAnalysisMainDebtsDuty_Load(object sender, EventArgs e)
		{
		...
		private void InitializeComponent()
		{
			...
			this.dtPeriod.FormatType = FormatTypeEnum.ShortDate;
			...
			base.Name = "frmPrintAnalysisMainDebtsDuty";
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "Анализ дебиторской задолженности";
			base.Load += new EventHandler(this.frmPrintAnalysisMainDebtsDuty_Load);
