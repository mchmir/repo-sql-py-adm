...
namespace Gefest
{
	public class frmPrintNoAkt : Form
	{
		...
		private void cmdOK_Click(object sender, EventArgs e)
		{
			...
			num1 = Convert.ToInt64(this.comboBox1.Text);
			this.Rep(d, num, num1);
			base.Close();
		}
		...
		private void InitializeComponent()
		{
			...
			ResourceManager resourceManager = new ResourceManager(typeof(frmPrintNoAkt));
			...
			this.label1.Location = new Point(4, 72);
			...
			this.comboBox1.Items.AddRange(new object[] { "1", "2" });
			this.comboBox1.Location = new Point(48, 72);
			this.comboBox1.Name = "comboBox1";
			this.comboBox1.Size = new System.Drawing.Size(96, 21);
			this.comboBox1.TabIndex = 70;
			this.comboBox1.Text = "1";
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			base.ClientSize = new System.Drawing.Size(364, 130);
			base.Controls.Add(this.cmdClose);
			base.Controls.Add(this.cmdOK);
			base.Controls.Add(this.groupBox1);
			base.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
			base.Name = "frmPrintNoAkt";
		...
		private void Rep(long IDGRU, long Agent, long idperiod)
		{
			this.Cursor = Cursors.WaitCursor;
			int[] numArray = new int[] { 2, 2, 2 };
			string[] str = new string[] { "@idperiod", "@idgru", "@idagent" };
			string[] strArrays = str;
			str = new string[] { idperiod.ToString(), IDGRU.ToString(), Agent.ToString() };
			string[] strArrays1 = str;
			string str1 = string.Concat(Depot.oSettings.ReportPath.Trim(), "repNoAkt.rpt");
			Form frmReport = new frmReports(str1, strArrays, strArrays1, numArray)
			{
				Text = "Наряд по абонентам без актов",
