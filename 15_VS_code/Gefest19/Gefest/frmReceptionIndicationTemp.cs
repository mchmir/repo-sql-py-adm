...
namespace Gefest
{
	public class frmReceptionIndicationTemp : Form
	{
		...
		private IndicationTemp tmpIndication;
		...
		public frmReceptionIndicationTemp()
		{
			...
			try
			{
				if (this.txtAccount.Text.Length != 0)
				{
					...
					else
					{
						...
						this.lblAccount.Text = this.txtAccount.Text;
		...
		private void cmdAddress_Click(object sender, EventArgs e)
		{
			...
			if (_frmAddress.DialogResult == System.Windows.Forms.DialogResult.OK)
			{
				...
				Label label2 = this.lblFIO2;
				Label label3 = this.lblFIO;
				string fullName = this._contract.oPerson.FullName;
				str = fullName;
				label3.Text = fullName;
				label2.Text = str;
				Label label4 = this.lblCountLives2;
				Label label5 = this.lblCountLives;
				string str1 = this._gobject.CountLives.ToString();
				str = str1;
				label5.Text = str1;
				label4.Text = str;
				this._gmeter = this._gobject.GetActiveGMeter();
				if (this._gmeter != null)
				{
					Label label6 = this.lblPU2;
					string str2 = "Подключен";
					str = str2;
					this.lblPU.Text = str2;
					label6.Text = str;
					this.lblCurrentIndication.Text = Convert.ToString(this._gmeter.GetCurrentIndication().Display);
					Label str3 = this.lblDateIndication;
					DateTime datedisplay = this._gmeter.GetCurrentIndication().Datedisplay;
				...
				{
					Label label7 = this.lblPU2;
					string str4 = "Не подключен";
					str = str4;
					this.lblPU.Text = str4;
					label7.Text = str;
					this.numNewIndication.Value = new decimal(0);
					this.numNewIndication.Enabled = false;
				}
		...
		private void FillOneItem(IndicationTemp o, bool isAdd)
		{
			try
			{
				this.Cursor = Cursors.WaitCursor;
		...
		private void frmReceptionIndicationTemp_Closing(object sender, CancelEventArgs e)
		{
		}

		private void frmReceptionIndicationTemp_KeyUp(object sender, KeyEventArgs e)
		{
			switch (e.KeyCode)
			{
				case Keys.F1:
		...
		private void frmReceptionIndicationTemp_Load(object sender, EventArgs e)
		{
			try
			{
		...
		private void InitializeComponent()
		{
			...
			ResourceManager resourceManager = new ResourceManager(typeof(frmReceptionIndicationTemp));
			...
			ColumnHeader[] columnHeaderArray = new ColumnHeader[] { this.columnHeader1, this.columnHeader2, this.columnHeader4, this.columnHeader3 };
			...
			base.Name = "frmReceptionIndicationTemp";
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "Прием показаний от потребителей до закрытия периода";
			base.Closing += new CancelEventHandler(this.frmReceptionIndicationTemp_Closing);
			base.Load += new EventHandler(this.frmReceptionIndicationTemp_Load);
			base.KeyUp += new KeyEventHandler(this.frmReceptionIndicationTemp_KeyUp);
