...
namespace Gefest
{
	public class frmPrintSpravkaVnovUstPU : Form
	{
		...
		public frmPrintSpravkaVnovUstPU()
		{
		...
		private void frmPrintSpravkaVnovUstPU_Load(object sender, EventArgs e)
		{
		...
		{
			ResourceManager resourceManager = new ResourceManager(typeof(frmPrintSpravkaVnovUstPU));
			...
			this.cmbAgent.Location = new Point(52, 36);
			...
			this.cmdOK.Location = new Point(116, 72);
			...
			this.cmdClose.Location = new Point(224, 72);
			this.cmdClose.Name = "cmdClose";
			this.cmdClose.Size = new System.Drawing.Size(92, 24);
			this.cmdClose.TabIndex = 73;
			this.cmdClose.Text = "Отмена";
			this.cmdClose.Click += new EventHandler(this.cmdClose_Click);
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			base.ClientSize = new System.Drawing.Size(318, 98);
			base.Controls.Add(this.cmdOK);
			base.Controls.Add(this.cmdClose);
			base.Controls.Add(this.groupBox1);
			base.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
			base.Name = "frmPrintSpravkaVnovUstPU";
			this.Text = "Справка по вновь установленным ПУ";
			base.Load += new EventHandler(this.frmPrintSpravkaVnovUstPU_Load);
		...
		private void Rep(long Agent)
		{
			try
			{
				try
				{
					...
					string[] str = new string[] { "@Bdate", "@Edate", "@idagent" };
					...
					string str1 = string.Concat(Depot.oSettings.ReportPath.Trim(), "repSpravkaVnovUstPU.rpt");
					Form frmReport = new frmReports(str1, strArrays, strArrays1, numArray)
					{
						Text = "Справка по вновь установленным ПУ",
