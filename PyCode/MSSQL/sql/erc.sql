select 
  ...
  CAST(ROUND(PredPokaz, 2) AS decimal(16,3)) PredPokaz, --20
  CAST(ROUND(TekPokaz, 2) AS decimal(16,3)) TekPokaz, --21
  ...
  Primechanie, --37
  coalesce(Occupancy, 0) As Common --38 Общее количество проживающих
from AAAERC7
ORDER BY Account