...
echo ==================================================================================
echo  Скрипт для копирования архива программных файлов
...
:: 1. Копирование папки D:\YandexDisk\YandexDisk\data engineering в H:\WORK
...
:: 2. Копирование папки C:\_git в H:\WORK
